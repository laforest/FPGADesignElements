...
// Made for on-chip Block RAMs (BRAMs) and LUT-RAM.  One write port and one
// read port, separately addressed, with a common clock.  Common data width on
// both ports. *This is usually the fastest BRAM configuration when used with
// write-forwarding logic.* The READ_NEW_DATA parameter control the behaviour
// of simultaneous reads and writes to the same address. This is the most
// important parameter when considering what kind of memory block the CAD tool
// will infer.
